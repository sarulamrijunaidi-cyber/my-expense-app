...
# Ensure the expense database exists
...
# Load and fix missing 'Username' column for old data
...
# Filter view for the history editor
current_history = user_data[user_data['Month_Year'] == current_month].sort_values('Date', ascending=False)
...
if st.button("💾 Save Changes (Update/Delete)"):
    # Remove user's data and add edited data back
...
if not user_data.empty:
    ...
    with c2:
        ...
        # Fix: Defines monthly_data before use
